...
async function init(args) {
  ...
  console.log(c.gray('  agenctx add warn "important gotcha"'));
  console.log(c.gray('  agenctx add decision "why we chose X"'));
  console.log(c.gray('  agenctx view'));
  console.log(c.gray('  agenctx dump all'));
}
